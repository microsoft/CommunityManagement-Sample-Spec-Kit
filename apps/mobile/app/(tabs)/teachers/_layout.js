...
exports.default = TeachersLayout;
/**
...
function TeachersLayout() {
    return (<expo_router_1.Stack screenOptions={__assign({ headerTitleStyle: { fontWeight: "600" } }, (react_native_1.Platform.OS === "ios"
      ...
      <expo_router_1.Stack.Screen name="index" options={{ title: "Teachers" }}/>
      <expo_router_1.Stack.Screen name="[id]" options={{ title: "Teacher Profile" }}/>
    </expo_router_1.Stack>);
}
