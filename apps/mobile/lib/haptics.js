...
exports.lightFeedback = lightFeedback;
exports.mediumFeedback = mediumFeedback;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light)];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success)];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error)];
                case 2:
                    _b.sent();
                    return [3 /*break*/, 4];
                case 3:
