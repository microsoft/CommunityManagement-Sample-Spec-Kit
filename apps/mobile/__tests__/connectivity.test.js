...
describe("connectivity module", function () {
    describe("checkConnectivity", function () {
        it("returns connected state", function () { return __awaiter(void 0, void 0, void 0, function () {
            var state;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, connectivity_1.checkConnectivity)()];
                    case 1:
                        state = _a.sent();
        ...
        it("returns disconnected state", function () { return __awaiter(void 0, void 0, void 0, function () {
            var state;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("handles null isConnected gracefully", function () { return __awaiter(void 0, void 0, void 0, function () {
            var state;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
