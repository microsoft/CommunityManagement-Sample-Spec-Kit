...
**Created**: 2025-07-09  
**Status**: Draft  
**Input**: User description: "Azure publishing. Create Azure publishing GitHub Actions that does nightly build and full test to its own environment. This is separate from the existing staging and production deploy workflow."
